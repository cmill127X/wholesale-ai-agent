...
def to_canonical(rows: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    for row in rows:
        output.append({
            ...
            "property_city": row.get("PROP_CITY", ""),
            "property_state": row.get("PROP_STATE", ""),
            "property_zip": row.get("PROP_ZIP", ""),
            "mailing_city": row.get("MAILINGCIT", ""),
            "mailing_state": row.get("MAILINGSTA", ""),
            "mailing_zip": row.get("MAILINGZIP", ""),
            ...
            "parcel_status": row.get("PARCELSTAT", ""),
